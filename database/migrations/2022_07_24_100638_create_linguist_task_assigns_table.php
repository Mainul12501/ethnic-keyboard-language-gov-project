...
class CreateLinguistTaskAssignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('linguist_task_assigns', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('linguist_task_assigns');
    }
}
