                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="row mb-3">
                                ...
                                <div class=" input-group">
                                    <input class="form-control @error('name') is-invalid @enderror" name="name" id="name" type="text" value="{{$supervisor->name}}" required>
                                    @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" type="number" value="{{$supervisor->phone}}" required>
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class=" input-group">
                                    <input class="form-control @error('email') is-invalid @enderror" name="email" id="email" type="email" value="{{$supervisor->email}}" required>
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class=" input-group">
                                    <input class="form-control @error('nid') is-invalid @enderror" name="nid" id="nid" type="number" value="{{$supervisor->nid}}" required>
                                    @error('nid')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class=" input-group">
                                    <input class="form-control @error('join_date') is-invalid @enderror" name="join_date" id="join_date" type="date" value="{{$supervisor->join_date}}" required>
                                    @error('join_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class=" input-group">
                                    <input class="form-control @error('education') is-invalid @enderror" name="education" id="education" type="text" value="{{$supervisor->education}}">
                                    @error('education')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control @error('short_bio') is-invalid @enderror" name="short_bio" id="short_bio" cols="30" rows="3">{{$supervisor->short_bio}}</textarea>
                                    @error('short_bio')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="address" cols="30" rows="3">{{$supervisor->address}}</textarea>
                                    @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
