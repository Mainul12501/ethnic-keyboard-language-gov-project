                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class=" input-group">
                                    <input class="form-control @error('nid') is-invalid @enderror" name="nid" id="nid" type="number" placeholder="{{__('messages.এনআইডি')}}" value="{{old('nid')}}">
                                    @error('nid')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class=" input-group">
                                    <input class="form-control @error('join_date') is-invalid @enderror" name="join_date" id="join_date" type="date" value="{{old('join_date')}}" required>
                                    @error('join_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
