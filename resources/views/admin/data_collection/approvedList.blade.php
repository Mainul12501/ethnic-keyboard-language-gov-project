                        ...
                        @foreach($dataCollections as $key=>$dataCollection)
                            <tr>
                                ...
                                @if($dataCollection->spontaneous)
                                    ...
                                    <td class="align-middle"><a href="{{route('admin.data_collections.spontaneous.edit', $dataCollection->id)}}">{{$dataCollection->spontaneous->word}}</a></td>
                                @endif
                                ...
                                @if(Auth::user()->user_type == 4)
                                    <td class="align-middle">
                                        <a class="btn btn-success btn-sm text-white" href="{{ route('trim-page',['type'=>isset($dataCollection->d_c_directed_id) ? 'directed' : 'spontaneous', 'id' => $dataCollection->id]) }}">
