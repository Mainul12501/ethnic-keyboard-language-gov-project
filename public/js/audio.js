...
// function audioTrim()
// {
//     var audioTrim= document.createElement("a");
//     document.getElementById("audio-button");
//     (0>= newRegion.stop.toFixed(4) ? 0 : newRegion.start.toFixed(4));
//     document.newRegion.stop();

//     document.getDuration.arrBuffer();
// }
// function loadAudio(){
// 	var element = document.getElementById("audio-file");
// 	if(element.files[0].type != "audio/mpeg"){
...
// 		wavesurfer.enableDragSelection({});
// 		console.log(intro)
//         totalAudioDuration = wavesurfer.create({
//             container: "#wavesurfer",
//             waveColor:"green",
//             progressColor:"blue",
//             responsive: true,
...
// 	 });
// 	 wavesurfer.on('finish',setrPlayButton);
// 	 wavesurfer.on('audioProcess',function(){
// 		 if(wavesurfer.isPlaying(){
// 			var currentTime = wavesurfer.getCurrentTime();
